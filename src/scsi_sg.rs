...
//ADAM: With a few edits
//TODO This should be generated on the system building the library. It was included
//  because RHEL 7 doesn't have a default/standard way to install clang 3.9, a requirement for bindgen.
//  Also need to figure out settings to avoid manual editing if possible.
